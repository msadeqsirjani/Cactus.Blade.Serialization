...
namespace Serialization.Test
{
    public class DefaultXmlSerializerTest
    {
        ...
        private const string ExpectedXml = @"<?xml version=""1.0"" encoding=""utf-8""?><TypeForXmlSerializer xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema""><PropA>5</PropA><PropB>true</PropB><PropC>PropC</PropC></TypeForXmlSerializer>";
        ...
        public void DeserializeFromStringDeserializesCorrectly()
        {
            ...
            var item = serializer.DeserializeFromString(ExpectedXml, typeof(TypeForXmlSerializer)) as TypeForXmlSerializer;
